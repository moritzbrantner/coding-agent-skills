...
Inspect module/service boundaries, dependency direction, public surface area, state ownership, duplicated policy, cross-cutting coupling, and whether abstractions correspond to real independent concepts. Compare the code to settled ADR/domain knowledge and the design doctrine in `coding-agent-conventions`.
...
The output should be usable by `codebase-design` or `improve-codebase-architecture`; this skill does not mutate code.
