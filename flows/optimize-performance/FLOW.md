...
Re-run correctness verification and the same representative measurement after the change. Report both the performance delta and any variance/uncertainty. Do not claim success from code shape alone.
